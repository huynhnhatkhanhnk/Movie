...
<%-- 			<jsp:include page="/comon/inform.jsp"></jsp:include> --%>
				<div class="row">
					<iframe width="935" height="517" src="https://www.youtube.com/embed/${videos.videoId	}" frameborder="0" allow="accelerometer; autoplay;
	...
	<div class="col-4">
		<div class="list-group"><a href="DetailsServlet?vid=${videos.videoId }" class="list-group-item list-group-item-action">
					<div class="row">
						<div class="col-4"><img src="${videos.poster }" alt="" width="300px" height="500px" class="img-fluid" >
							<h6 class="mb-1"></h6></div>
						<div class="col-7">
							<p class="mb-1">${videos.title }</p> <small class="text-muted">${videos.description }</small>
					</div>
				</div>
			</a>  
